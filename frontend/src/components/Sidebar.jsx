...
import { FaHome, FaUser, FaRobot, FaChartLine, FaCog, FaBook } from 'react-icons/fa';

const Sidebar = ({ isOpen }) => {
  return (
    <div className={`fixed z-20 bg-[#000A17] w-64 min-h-screen px-4 py-6 transition-transform duration-300 ease-in-out ${isOpen ? 'translate-x-0' : '-translate-x-full'}`}>
